 ...
 * If AWS_S3_FORCE_PATH_STYLE is set to 'true', path-style URLs will be used.
 * Otherwise, virtual-hosted-style URLs will be used (recommended for S3-compatible services).
 *
